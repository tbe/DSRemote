...
public:
    ...
    int adjDialFunc, navDialFunc;

    QTimer *scrn_timer, *label_timer;
...
private:
    ...
    QMenu *devicemenu, *settingsmenu, *helpmenu;

    QTimer *adjdial_timer, *navDial_timer, *horPosDial_timer, *trigAdjDial_timer,
        *vertOffsDial_timer, *horScaleDial_timer, *vertScaleDial_timer, *test_timer;

    QStatusBar *statusBar;

    QLabel *adjDialLabel, *horScaleLabel, *horPosLabel, *vertScaleLabel, *vertOffsetLabel,
        *trigLevelLabel, *trigModeLabel, *ch1InputLabel, *ch2InputLabel, *ch3InputLabel,
        *ch4InputLabel;
    ...
    QGroupBox *verticalGrpBox, *horizontalGrpBox, *triggerGrpBox, *menuGrpBox, *quickGrpBox;

    QPushButton *ch1Button, *ch2Button, *ch3Button, *ch4Button, *chanMenuButton, *clearButton,
        *autoButton, *runButton, *singleButton, *horMenuButton, *trigModeButton, *trigMenuButton,
        *trigForceButton, *trig50pctButton, *acqButton, *cursButton, *saveButton, *dispButton,
        *utilButton, *helpButton, *playpauseButton, *stopButton, *recordButton, *measureButton,
        *mathMenuButton;

    TDial *adjDial, *horScaleDial, *horPosDial, *vertScaleDial, *vertOffsetDial, *trigAdjustDial,
        *navDial;
    ...
    QAction *former_page_act, *shift_page_left_act, *shift_page_right_act, *next_page_act,
        *zoom_in_act, *zoom_out_act, *chan_scale_plus_act, *chan_scale_plus_all_channels_act,
        *chan_scale_minus_act, *chan_scale_minus_all_channels_act, *shift_trace_up_act,
        *shift_trace_down_act, *select_chan1_act, *select_chan2_act, *select_chan3_act,
        *select_chan4_act, *toggle_fft_act, *center_trigger_act, *center_position_act,
        *save_screenshot_act;

    struct tmcdev *device;

    TLed *trigModeAutoLed, *trigModeNormLed, *trigModeSingLed;
